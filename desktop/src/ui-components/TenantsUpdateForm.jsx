...
import { getTenants } from "../graphql/queries";
import { updateTenants } from "../graphql/mutations";
export default function TenantsUpdateForm(props) {
  ...
  React.useEffect(resetStateValues, [tenantsRecord]);
  const validations = {
    name: [],
  };
