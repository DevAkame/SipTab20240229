...
export declare type AddRecordFormOverridesProps = {
    AddRecordForm?: PrimitiveOverrideProps<FlexProps>;
...
export declare type AddRecordFormProps = React.PropsWithChildren<Partial<FlexProps> & {
    Category?: React.ReactNode;
    category?: React.ReactNode;
} & {
    overrides?: AddRecordFormOverridesProps | undefined | null;
}>;
export default function AddRecordForm(props: AddRecordFormProps): React.ReactElement;
