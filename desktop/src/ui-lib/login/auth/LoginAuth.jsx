...
export default function AuthViews(props) {
    ...
    const [TextSginInEmail,setTextSginInEmail] = useStateMutationAction("");
      ...
      >
        ...
        >
            <TextField
                ...
                onChange={(e) => setTextSginInEmail(e.target.value)}
            ...
            <PasswordField
                ...
                onChange={(e) => setTextSginInPasswd(e.target.value)}
